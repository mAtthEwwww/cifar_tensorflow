        ...
        class _Hook(tf.train.SessionRunHook):
            ...
            def after_run(self, run_context, run_values):
                ...
                if step % FLAGS.log_frequency == 0:
                    ...
                    format_str = ('lr: %.4f, step: %d, loss: %.2f (%.1f examples/sec; %.3f sec/batch)')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
            '--train_dir',
            type=str,
            default='/home/mattheww/machine_learning/datasets/cifar10/resnet_train2',
